create table route_stop (
	...
	arrival time,
	departure time,
	constraint pk_routestop_routeid_stopid primary key (route_id, stop_id),
...
create unique index idx_routestop_routeid_stop_id on route_stop (id);
...
cluster route_stop using idx_routestop_routeid_stop_id;